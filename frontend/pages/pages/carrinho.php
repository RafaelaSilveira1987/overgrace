...
<body>
        ...
        <div class="cart-layout" id="cartLayout">
            ...
            <div class="cart-items">
                ...
                <div>
                    <div class="coupon-row">
                        <input type="text" id="couponInput" placeholder="Código de cupom" maxlength="50" />
            ...
            <div class="cart-summary">
                ...
                <div class="summary-row total">
                    ...
                    <span class="value" id="total-items">R$ 0,00</span>
                </div>
    ...
    <div class="suggested">
        ...
        <div class="suggested-grid">
            <div class="sug-card">
                <div class="sug-img">
                    <img src="https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=400&q=80"
            ...
            <div class="sug-card">
                <div class="sug-img">
                    <img src="https://images.unsplash.com/photo-1622445275463-afa2ab738c34?w=400&q=80"
            ...
            <div class="sug-card">
                <div class="sug-img">
                    <img src="https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=400&q=80"
                        alt="Boné Bucket" />
                </div>
            ...
            <div class="sug-card">
                <div class="sug-img">
                    <img src="https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=400&q=80"
                        alt="Kit Camisa + Boné" />
                </div>
