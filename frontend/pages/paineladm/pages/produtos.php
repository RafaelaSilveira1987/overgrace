            ...
            <div class="page-content">
                <div class="page-header">
                    ...
                    <div class="page-header-actions">
                        ...
                        <button class="btn btn-primary" onclick="openModal()">
                            <svg width="14" height="14" fill="none" viewBox="0 0 14 14" stroke="currentColor"
                                stroke-width="2">
                ...
                <div class="stats-mini">
                    <div class="stat-mini">
                        ...
                        <div class="stat-mini-sub">Ativos: <span id="active">0</span> · Inativos: <span
                                id="inactive">0</span></div>
                    </div>
                    <div class="stat-mini">
                    ...
                    <div class="stat-mini">
                        ...
                        <div class="stat-mini-sub">Mín R$<span id="min_price">0</span> · Máx R$<span
                                id="max_price">0</span></div>
                    </div>
                </div>
                ...
                <form id="formProd">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-input" type="number" placeholder="149.00 (opcional)" id="f-price-old"
                                step="0.01" />
                        ...
                        <div class="form-group form-full">
                            ...
                            <textarea class="form-textarea" placeholder="Boné 5 painéis em ripstop de algodão…"
                                id="f-desc" style="min-height: 96px"></textarea>
                        </div>
                        <div class="form-group">
