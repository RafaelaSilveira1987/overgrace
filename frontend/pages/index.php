...
<body>
    ...
    <section class="section" id="categorias">
        <div class="section-header">
            ...
            <a href="lista" class="section-link">Ver tudo ►</a>
        </div>
    ...
    <section class="products-section" id="produtos">
        <div class="section-header">
            ...
            <a href="lista?destaques=true" class="section-link">Ver tudo ►</a>
        </div>
    ...
    <footer>
        <div class="footer-top">
            ...
            <div class="footer-col">
                <h4>Loja</h4>
                <a href="lista">Camisas</a>
                <a href="lista">Bonés</a>
                <a href="lista">Cropped</a>
                <a href="lista">Kits</a>
            </div>
            <div class="footer-col">
                <h4>Empresa</h4>
            ...
            <div class="footer-col">
                <h4>Ajuda</h4>
                <a href="minha-conta">trocas e Devoluções</a>
                <a href="minha-conta">Rastrear Pedido
                </a>
                <a href="lista">Tamanhos</a>
                <a href="sobre">FAQ</a>
            </div>
        </div>
        <div class="footer-bottom">
            ...
            <div class="footer-socials">
                <a href="https://instagram.com/overgrace" target="_blank">Instagram</a>
